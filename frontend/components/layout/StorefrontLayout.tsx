...
import CustomWatchPopup from "@/components/marketing/CustomWatchPopup";
...
export default function StorefrontLayout({ children }: { children: React.ReactNode }) {
  ...
  const isShowroom = pathname === "/customizer";
  ...
  return (
    <>
      {!isShowroom && <AnnouncementBar />}
      <Header showroom={isShowroom} />
