...
async function cleanup() {
  ...
  // 1. Delete order items / reviews / customer results associated if any
  ...
  // 3. Delete SHYN.ISH Instagram Reels
  ...
  // 4. Delete HomepageSection if created for SHYN.ISH
  try {
    ...
    console.log("HomepageSection cleanup skipped or not present");
  }

  // 5. Restore siteSettings for Eshara if needed
  try {
