      ...
      <div className="relative z-10 p-6 grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
        ...
        <div className="md:col-span-5 flex flex-col items-center justify-center p-4 rounded-xl bg-black/20 border border-white/10">
          <div className="relative w-36 h-36 mb-2">
            ...
            <Image
              src={form.imageUrl || "/assets/layered-bottle.png"}
              alt="Offer Product"
              fill
      ...
      try {
        ...
        if (data.offer) {
          ...
          setForm({
            ...
            imageUrl: o.imageUrl || "/assets/layered-bottle.png",
            isActive: o.isActive,
          });
        }
      } catch (e) {
              ...
              {form.items.map((item, i) => (
                <div key={i} className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    style={{ borderColor: "rgba(26,26,26,0.15)" }}
                    placeholder="e.g. 100ml Hair Oil"
                  />
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-3">
              ...
              <div className="flex-1 space-y-2 w-full">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <button
                    type="button"
                    onClick={() => set("imageUrl", "/assets/layered-bottle.png")}
