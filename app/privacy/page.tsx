...
export const metadata: Metadata = {
  title: "Privacy Policy | SHYN.ISH",
  description: "Read the Privacy Policy for SHYN.ISH. Learn how we collect, use, and protect your personal information.",
  alternates: {
    canonical: "/privacy",
  },
  openGraph: {
    title: "Privacy Policy | SHYN.ISH",
    description: "Learn how SHYN.ISH collects, uses, and protects your personal information.",
    url: "/privacy",
    siteName: "SHYN.ISH",
    type: "website",
  },
    ...
    <div className="min-h-screen bg-[#FAF8F5]">
      <div className="max-w-3xl mx-auto px-6 py-24">
        <div className="mb-12">
          ...
          <h1 className="font-serif text-4xl md:text-5xl text-[#141312] mb-4">Privacy Policy</h1>
        ...
        <div className="prose prose-sm max-w-none font-sans text-gray-700 space-y-8 leading-relaxed">
          <section>
            <h2 className="font-serif text-2xl text-[#141312] mb-3">1. Information We Collect</h2>
            <p>When you visit SHYN.ISH, we may collect the following information:</p>
          ...
          <section>
            <h2 className="font-serif text-2xl text-[#141312] mb-3">2. How We Use Your Information</h2>
            <ul className="list-disc pl-6 space-y-2">
              <li>To process and fulfill your orders.</li>
              <li>To send order confirmations and shipping updates.</li>
              <li>To respond to your customer service inquiries.</li>
              <li>To send promotional updates (you can unsubscribe at any time).</li>
              <li>To improve our website and product offerings.</li>
            </ul>
          </section>

          <section>
            <h2 className="font-serif text-2xl text-[#141312] mb-3">3. Data Sharing</h2>
          ...
          <section>
            <h2 className="font-serif text-2xl text-[#141312] mb-3">4. Cookies</h2>
          ...
          <section>
            <h2 className="font-serif text-2xl text-[#141312] mb-3">5. Data Security</h2>
          ...
          <section>
            <h2 className="font-serif text-2xl text-[#141312] mb-3">6. Your Rights</h2>
          ...
          <section>
            <h2 className="font-serif text-2xl text-[#141312] mb-3">7. Contact Us</h2>
            <p>If you have any questions about this privacy policy, please contact us at <a href="mailto:support@shynish.com" className="text-[#C5A059] underline">support@shynish.com</a>.</p>
          </section>
        </div>
